...
<div class="sub-wrap">
	<div class="sub-inner-box">
		<div class="sub-inner-txt2">
			<span class="sub-txt"> 코드북<br>
				<span class="project-txt-lighter">자발적인 에디터 참여로 만들어지는 코드북!</span>
			</span>
		</div>
...
<section class="section-wrap">
	...
	<div class="writing-view">
	    ...
	    <div class="board-btn-wrap">
			<c:url value="/outs/board/codebook/codeUpdate.do" var="updateURL">
			...
			<c:url value="/outs/board/codebook/codeDelete.do" var="deleteURL">
				<c:param name="what" value="${board.boNum }" />
				<c:param name="writer" value="${board.memId }" />				
			</c:url>	
			<input id="deleteBtn" type="button" value="글삭제" class="linkBtn btn-delete width-60" data-gopage="${deleteURL}" />
			<c:if test="${authMember.memRole eq 'ADMIN'}">
				<input type="button" id="blackBtn" value="블랙리스트 등록" class="linkBtn btn-delete"/>
				<input id="deleteBtn" type="button" value="글삭제" class="linkBtn btn-delete" data-gopage="${deleteURL}">
			</c:if>
		</div> 
