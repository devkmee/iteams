...
<div>
	<div class="sub-wrap">
		...
		<c:url value="/outs/board/qna/faqList.do" var="listURL"></c:url>
		...
		<div class="writing-view-wrap">
			<div class="writing-view">
				<div class="writing-title">
					<span><label>[</label>${board.qnaKeywordValue}<label>]</label> ${board.boTitle }</span>
				</div>
			...
			<div class="board-btn-wrap">
				<c:if test="${authMember.memRole eq 'ADMIN' }">
					<c:url value="/outs/admin/board/qna/faqUpdate.do" var="updateURL">
...
<form id="deleteForm" action="${cPath }/outs/admin/board/qna/FAQDelete.do" method="post">
