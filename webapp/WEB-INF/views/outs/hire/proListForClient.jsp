		...
		<div class="tab-wrap">
			<ul class="nav nav-tabs m-bottom-20" id="myTab" role="tablist">
			  <li class="nav-item m-right-2" role="presentation">
			    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">회원정보 수정</a>
			  </li>
			...
			<div class="tab-content" id="myTabContent">
			  <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
				<div class="mypage-info-wrap">
					...
					<button type="submit" class="btn btn-primary m-right-10 p-btn-1030">수정</button>
			  ...
			  <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
				<div class="project-wrap">
					...
					<div class="employment-wrap">
						<c:set var="projectList" value="${hire.dataList }"></c:set>
						<c:choose>
