...
<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
							...
							<div class="member-basic-wrap">
								...
								<form:form action="${cPath}/outs/message/sendPMSMessage.do" modelAttribute="messageVO" method="post" enctype="multipart/form-data">
									<table class="table">
									    <tr>
											<th>제목</th>
											<td><form:input path="msgTitle" type="text" name="msgTitle" class="form-control"/>
												<form:errors path="msgTitle" cssClass="error" element="span"></form:errors></td>
										</tr>
									    <tr>
									      <th>받는사람 아이디</th>
									      <td><form:input path="msgReceive" id="receiveId" type="text" name="msgReceive" class="form-control" />
