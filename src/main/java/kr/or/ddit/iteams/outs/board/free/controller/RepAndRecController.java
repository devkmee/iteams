...
public class RepAndRecController {
	...
	@RequestMapping(value="/outs/board/free/recommend.do", produces=MediaType.APPLICATION_JSON_UTF8_VALUE)
	@ResponseBody
	public Object recommend(@ModelAttribute MasterVO masterVO
	...
	@RequestMapping(value="/outs/board/free/report.do", produces=MediaType.APPLICATION_JSON_UTF8_VALUE)
	@ResponseBody
