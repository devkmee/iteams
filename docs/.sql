...
INSERT INTO ROLES(AUTHORITY, ROLE_NAME, DESCRIPTION, CREATE_DATE, MODIFY_DATE) VALUES('ROLE_RESTRICTED', 'RESTRICTED', '제한된 사용자',SYSDATE, SYSDATE);
INSERT INTO ROLES(AUTHORITY, ROLE_NAME, DESCRIPTION, CREATE_DATE, MODIFY_DATE) VALUES('ROLE_USER', 'USER', '일반 사용자',SYSDATE, SYSDATE);
INSERT INTO ROLES(AUTHORITY, ROLE_NAME, DESCRIPTION, CREATE_DATE, MODIFY_DATE) VALUES('ROLE_A', 'A', 'A 업무',SYSDATE, SYSDATE);
INSERT INTO ROLES(AUTHORITY, ROLE_NAME, DESCRIPTION, CREATE_DATE, MODIFY_DATE) VALUES('ROLE_B', 'B', 'B 업무',SYSDATE, SYSDATE);
INSERT INTO ROLES(AUTHORITY, ROLE_NAME, DESCRIPTION, CREATE_DATE, MODIFY_DATE) VALUES('ROLE_SUPERVISOR', 'SUPERVISOR', '상위등급사용자',SYSDATE, SYSDATE);
INSERT INTO ROLES(AUTHORITY, ROLE_NAME, DESCRIPTION, CREATE_DATE, MODIFY_DATE) VALUES('ROLE_ADMIN', 'ADMIN', '시스템관리자',SYSDATE, SYSDATE);

---- 새로운 업무에 해당하는 역할이 등록되는 경우, ROLE_RESTRICTED 의 자식 형태로 계층구조를 등록함.
...
INSERT INTO ROLES_HIERARCHY(CHILD_ROLE, PARENT_ROLE) VALUES('ROLE_ADMIN', 'ROLE_SUPERVISOR');
INSERT INTO ROLES_HIERARCHY(CHILD_ROLE, PARENT_ROLE) VALUES('ROLE_SUPERVISOR', 'ROLE_USER');
...
INSERT INTO ROLES_HIERARCHY(CHILD_ROLE, PARENT_ROLE) VALUES('ROLE_SUPERVISOR', 'ROLE_A');
INSERT INTO ROLES_HIERARCHY(CHILD_ROLE, PARENT_ROLE) VALUES('ROLE_A', 'ROLE_RESTRICTED');
INSERT INTO ROLES_HIERARCHY(CHILD_ROLE, PARENT_ROLE) VALUES('ROLE_SUPERVISOR', 'ROLE_B');
...
-- ROLE_ADMIN, ROLE_SUPERVISIOR, ROLE_USER, ROLE_A 등의 역할 부여
--INSERT INTO AUTHORITIES (USERNAME, AUTHORITY) SELECT MEM_ID, MEM_ROLE FROM MEMBER;
UPDATE AUTHORITIES SET AUTHORITY = 'ROLE_ADMIN' WHERE USERNAME = 'c001';
UPDATE AUTHORITIES SET AUTHORITY = 'ROLE_SUPERVISOR' WHERE USERNAME = 'd001';
...
INSERT INTO GROUP_AUTHORITIES(GROUP_ID, AUTHORITY) VALUES (1, 'ROLE_A');
...
INTO SECURED_RESOURCES( RESOURCE_ID, RESOURCE_NAME, RESOURCE_PATTERN, RESOURCE_TYPE, DESCRIPTION, SORT_ORDER, RESOURCE_PARENT  )
VALUES ( 'web-000022', 'registMemberUrl', '/member/registMember.do', 'url', '신규가입', 1, 'web-000020' )
INTO SECURED_RESOURCES( RESOURCE_ID, RESOURCE_NAME, RESOURCE_PATTERN, RESOURCE_TYPE, DESCRIPTION, SORT_ORDER, RESOURCE_PARENT  )
VALUES ( 'web-000023', 'idCheckUrl', '/member/idCheck.do', 'url', '아이디체크', 1, 'web-000020' )

INTO SECURED_RESOURCES( RESOURCE_ID, RESOURCE_NAME, RESOURCE_PATTERN, RESOURCE_TYPE, DESCRIPTION, SORT_ORDER, RESOURCE_PARENT  )
VALUES ( 'web-000024', 'mypageUrl', '/mypage.do', 'url', '내정보', 1, 'web-000001' )
INTO SECURED_RESOURCES( RESOURCE_ID, RESOURCE_NAME, RESOURCE_PATTERN, RESOURCE_TYPE, DESCRIPTION, SORT_ORDER, RESOURCE_PARENT  )
VALUES ( 'web-000025', 'modifyMemberUrl', '/member/modifyMember.do', 'url', '내정보수정', 1, 'web-000024' )
INTO SECURED_RESOURCES( RESOURCE_ID, RESOURCE_NAME, RESOURCE_PATTERN, RESOURCE_TYPE, DESCRIPTION, SORT_ORDER, RESOURCE_PARENT  )
VALUES ( 'web-000026', 'removeMemberUrl', '/member/removeMember.do', 'url', '회원탈퇴', 1, 'web-000024' )
...
INSERT ALL
INTO SECURED_RESOURCES( RESOURCE_ID, RESOURCE_NAME, RESOURCE_PATTERN, RESOURCE_TYPE, DESCRIPTION, SORT_ORDER, RESOURCE_PARENT )
VALUES ( 'web-000037', 'guestBookUrl', '/book/*', 'url', '방명록REST', 2, 'web-000001' )
INTO SECURED_RESOURCES( RESOURCE_ID, RESOURCE_NAME, RESOURCE_PATTERN, RESOURCE_TYPE, DESCRIPTION, SORT_ORDER, RESOURCE_PARENT )
VALUES ( 'web-000038', 'guestBookUrl', '/guestBook.do', 'url', '방명록', 1, 'web-000037' )
SELECT * FROM DUAL;

INSERT INTO SECURED_RESOURCES_ROLE (RESOURCE_ID, AUTHORITY) VALUES ('web-000037', 'ROLE_A');
INSERT INTO SECURED_RESOURCES_ROLE (RESOURCE_ID, AUTHORITY) VALUES ('web-000038', 'ROLE_A');
